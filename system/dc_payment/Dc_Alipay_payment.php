...
class Dc_Alipay_payment implements payment {
	...
	public function get_payment_code($payment_notice_id)
	{
		...
		$data_return_url = SITE_DOMAIN.APP_ROOT.'/index.php?ctl=dc_payment&act=response&class_name=Alipay';
		$data_notify_url = SITE_DOMAIN.APP_ROOT.'/index.php?ctl=dc_payment&act=notify&class_name=Alipay';
		...
		$payLinks = '<button type="submit" class="ui-button paybutton" rel="blue">前往支付宝在线支付</button><form id="pay_form" action="https://mapi.alipay.com/gateway.do?'.$param. '&sign='.$sign_md5.'&sign_type=MD5" method="post" target="_blank"></form>';
