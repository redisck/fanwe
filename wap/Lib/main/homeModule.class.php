...
{	
	...
	public function tuan(){
		...
		$data = request_api("home","tuan",$param);
...
// 		print_r($data);exit;
		...
		//统计数据
		$data_goods = request_api("home","goods",$param);
		$data_youhui = request_api("home","youhui",$param);
		$data_event = request_api("home","event",$param);
	...
	public function goods(){
		...
		$param['page'] = intval($_REQUEST['page']);
		$request = $param;
		$data = request_api("home","goods",$param);
		...
		//统计数据
		$data_tuan = request_api("home","tuan",$param);
		$data_youhui = request_api("home","youhui",$param);
		$data_event = request_api("home","event",$param);
	...
	public function youhui(){
		...
		$data = request_api("home","youhui",$param);
// 		print_r($data);exit;
	...
	public function event(){
		...
		$data = request_api("home","event",$param);
