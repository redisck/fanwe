...
class dc_biz_orderModule extends MainBaseModule
{
	...
	{	
		...
		$data = request_api("dc_biz_order","index",$param);
	...
	public function order()
	{
		...
		$data = request_api("dc_biz_order","order",$param);
	...
	public function dc_reminder(){
		...
		$param['lid'] = intval($_REQUEST['lid']);
		$param['page']=intval($_REQUEST['page']);
		$data = request_api("dc_biz_order","dc_reminder",$param);
	...
	{	
		...
		$data = request_api("dc_biz_order","accept_order",$param);
	...
	public function close_order()
	{
		...
		$data = request_api("dc_biz_order","close_order",$param);
	...
	{	
		...
		init_app_page();
		$param['id'] = intval($_REQUEST['id']);
		$data = request_api("dc_biz_order","over_order",$param);
